object Form3: TForm3
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet4: TTabSheet
      ...
      object GroupBox1: TGroupBox
        ...
        object lbProductKey: TLabel
          Left = 16
          Top = 39
          Width = 103
          Height = 21
          Margins.Left = 12
          Caption = 'lbProductKey'
        end
        object lbInstallDate: TLabel
          Left = 15
          Top = 63
          Width = 98
          Height = 21
          Margins.Left = 12
          Caption = 'lbInstallDate'
        end
      end
      object GroupBox2: TGroupBox
        ...
        object GroupBox6: TGroupBox
          ...
          Height = 136
          Align = alBottom
          Caption = '   Disc Drive Information'
          DefaultHeaderFont = False
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -19
        ...
        object GroupBox7: TGroupBox
          ...
          object lbMB: TLabel
            ...
            Height = 21
            Margins.Left = 12
            Caption = 'Mother Board Information'
          end
        end
      end
    ...
    object TabSheet1: TTabSheet
      ...
      object Panel1: TPanel
        ...
        object GridPanel1: TGridPanel
          ...
          ColumnCollection = <
            item
              Value = 32.553014590710280000
            end
            item
              Value = 34.093787985990480000
            end
            item
              Value = 33.353197423299230000
            end>
          ControlCollection = <
            item
              Column = 0
          ...
          object EditFilter: TEdit
            ...
            Align = alClient
            TabOrder = 0
            Text = 'Search VendorID / DeviceID'
            OnChange = EditFilterChange
            OnMouseLeave = EditFilterMouseLeave
            ExplicitHeight = 23
          end
          object chkHideUnknown: TCheckBox
            Left = 333
            Top = 1
            Width = 347
            Height = 34
            ...
            State = cbChecked
            TabOrder = 1
            OnClick = chkHideUnknownClick
          end
          object chkNoDriver: TCheckBox
            Left = 680
            Top = 1
            Width = 340
            Height = 34
            Align = alClient
            Caption = 'No Driver Installed'
            TabOrder = 2
            OnClick = chkNoDriverClick
          end
          object Button1: TButton
            ...
            Height = 33
            Align = alClient
            Caption = 'Find MotherBoard Drivers'
            TabOrder = 3
          ...
          object Button5: TButton
            ...
            Height = 33
            Align = alClient
            Caption = 'Install selected Updates'
            TabOrder = 4
          ...
          object Panel5: TPanel
            ...
            object Button4: TButton
              ...
              Height = 31
              Align = alLeft
              Caption = 'Check For Updated Drivers'
              TabOrder = 0
    ...
    object TabSheet2: TTabSheet
      ...
      object lvStartUp: TListView
        ...
        TabOrder = 0
        ViewStyle = vsReport
        OnDblClick = lvStartUpDblClick
        OnItemChecked = lvStartUpItemChecked
      end
    ...
    object TabSheet3: TTabSheet
      ...
      object GridPanel2: TGridPanel
        ...
        ColumnCollection = <
          item
            Value = 33.158910166880790000
          end
          item
            Value = 33.445634448235050000
          end
          item
            Value = 33.395455384884180000
          end>
        ControlCollection = <
          item
            Column = 0
        ...
        object Panel2: TPanel
          ...
          object Button14: TButton
            ...
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'AdjustForBestPerformance'
            TabOrder = 3
          ...
          object Button7: TButton
            ...
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'Set Non Needed Services To Manual'
            TabOrder = 5
          ...
          object Button6: TButton
            ...
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'High Perfomance Power Plan'
            TabOrder = 6
          ...
          object Button44: TButton
            ...
            Width = 273
            Height = 25
            Caption = 'Disable RecentItems History'
            TabOrder = 8
          ...
          object Button45: TButton
            ...
            Width = 273
            Height = 25
            Caption = 'Enable RecentItems History'
            TabOrder = 9
          ...
          object Button52: TButton
            ...
            Width = 273
            Height = 25
            Caption = 'Emsisoft Emergency Kit'
            TabOrder = 16
        ...
        object Panel3: TPanel
          ...
          object Button27: TButton
            ...
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'Disable Consumer Features'
            ElevationRequired = True
            TabOrder = 0
          ...
          object Button26: TButton
            ...
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'Enable Consumer Features'
            ElevationRequired = True
            TabOrder = 1
          ...
          object Button8: TButton
            ...
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'Disable Windows Search Indexing'
            TabOrder = 4
          ...
          object Button10: TButton
            ...
            Height = 25
            Hint = 
              'On systems with SSDs, Superfetch (now often called SysMain) can ' +
              'cause unnecessary disk activity. You can disable it via WMI or t' +
              'he Service Control Manager (SCM) API. This reduces background di' +
              'sk I/O and can speed up overall responsiveness.'
            Margins.Left = 10
            Margins.Top = 10
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'Disable Superfetch (SysMain):'
            TabOrder = 5
          ...
          object Button11: TButton
            ...
            Height = 25
            Hint = 
              'Disable Unnecessary Scheduled Tasks:'#13#10'Many background tasks sche' +
              'duled by Windows or third'#8209'party software can run when not needed' +
              '. Using the Task Scheduler API or WMI, you can disable tasks tha' +
              't are not critical'#8212'such as those related to telemetry or mainten' +
              'ance that can be postponed.'
            Margins.Left = 10
            Margins.Top = 10
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'Disable Unnecessary Scheduled Tasks:'
            TabOrder = 6
          ...
          object Button12: TButton
            ...
            Height = 25
            Hint = 
              'Disable Background Apps:'#13#10'Windows 10/11 often runs many Universa' +
              'l Windows Platform (UWP) apps in the background. By modifying re' +
              'gistry settings or using the Windows API, you can disable backgr' +
              'ound activities for non-essential apps. This can help free up CP' +
              'U and memory resources.'
            Margins.Left = 10
            Margins.Top = 10
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'Disable Background Apps:'
            TabOrder = 7
          ...
          object Button13: TButton
            ...
            Height = 25
            Hint = 
              'Enable Fast Startup:'#13#10'Fast Startup (a hybrid shutdown/boot featu' +
              're) can significantly reduce boot times. You can enable it by up' +
              'dating specific registry keys and then forcing the system to re-' +
              'read its settings. This doesn'#8217't affect system performance while ' +
              'running but speeds up system startup.'
            Margins.Left = 10
            Margins.Top = 10
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'Enable Fast Startup:'
            ElevationRequired = True
            TabOrder = 8
          ...
          object Button16: TButton
            ...
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'Disable Windows Defender'
            ElevationRequired = True
            TabOrder = 10
          ...
          object Button17: TButton
            ...
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'Enable Windows Defender'
            ElevationRequired = True
            TabOrder = 11
          ...
          object Button42: TButton
            ...
            Width = 267
            Height = 25
            Caption = 'DisableNotificationCenter'
            TabOrder = 14
          ...
          object Button43: TButton
            ...
            Width = 267
            Height = 25
            Caption = 'EnableNotificationCenter'
            TabOrder = 15
        ...
        object Panel4: TPanel
          ...
          object Button38: TButton
            ...
            Width = 270
            Height = 25
            Caption = 'Open Defender Settings'
            TabOrder = 1
          ...
          object Button30: TButton
            ...
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'Hide Files And Folders'
            TabOrder = 4
          ...
          object Button33: TButton
            ...
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'InvokeUltimatePerformance'
            TabOrder = 7
          ...
          object Button35: TButton
            ...
            Margins.Right = 10
            Margins.Bottom = 10
            Caption = 'CreateSystemRestorePoint'
            ElevationRequired = True
            TabOrder = 11
  ...
  object PopupMenu1: TPopupMenu
    ...
    Left = 504
    Top = 32
    object SearchGoogle1: TMenuItem
      Caption = 'Search Google With VendorId & DevicepId'
      OnClick = SearchGoogle1Click
    end
    object FindDriver1: TMenuItem
      Caption = 'Find Driver'
      OnClick = FindDriver1Click
    end
    object SearchGoogleDeviceName1: TMenuItem
      Caption = 'Search Google Device Name'
      OnClick = SearchGoogleDeviceName1Click
    end
  end
